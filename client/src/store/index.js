...
function GlobalStoreContextProvider(props) {
    ...
    store.addNewSong = function () {
        ...
        this.addCreateSongTransaction(index, "Untitled", "Untitled", "dQw4w9WgXcQ");
    }
    ...
    store.addNewSong = () => {
        ...
        store.addCreateSongTransaction(
            playlistSize, "Untitled", "Untitled", "dQw4w9WgXcQ");
    }
    ...
    store.canUndo = function () {
        if ((store.currentList !== null) && tps.hasTransactionToUndo()) {
            if (store.isModalShown == false) {
                return true;
            }
            else {
    ...
    store.canRedo = function () {
        if ((store.currentList !== null) && tps.hasTransactionToRedo()) {
            if (store.isModalShown == false) {
                return true;
            }
            else {
